...
static const char *fonts[]          = { "Iosevka:size=17" };
...
static const char *volumeup[] = { "amixer", "-M", "-c", "1", "set", "Master", "5%+", NULL };
static const char *volumedown[] = { "amixer", "-M", "-c", "1", "set", "Master", "5%-", NULL };
static const char *volumemute[] = { "amixer", "-M", "-c", "1", "set", "Master", "toggle", NULL };
